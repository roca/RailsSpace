...
#  
#    respond_to do |format| 
#      format.js # Rails knows to use this file by defualt new.rjs 
#    end 
#  end
#  
#
...
# page.replace_html "new_comment_form_for_post_#{@post.id}", "<div id=\"new_comment_form_for_post...@post.id}\"></div>" 
