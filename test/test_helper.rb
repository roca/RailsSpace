...
# Test the minimum or maximum length of an attribute.
  ...
  def authorize(user)
    ...
    @request.session[:admin_id] =    user.friend_of_admin
#    admin  = User.find_by_screen_name('Administrator')
#    friendship = Friendship.find_by_user_id_and_friend_id(user, admin)
#       
#     if user.screen_name == 'Administrator'
#       @request.session[:admin_id] = admin.id 
#     elsif friendship  && friendship.status == 'accepted'
#       @request.session[:admin_id] = admin.id  
#     else
